...
# python train.py env=Metaworld env.env_reward_type='none' env.task_name='bin-picking-v2-goal-observable' env.temporal_encoding=true reward_model='temporal_ot' visual_encoder='resnet50' reward_model.cost_fn='diagonal_cosine' logging.wandb_mode='disabled' reward_model.tau=0.1
...
python train.py env=Metaworld env.env_reward_type='none' env.task_name='box-close-v2-goal-observable' env.temporal_encoding=true reward_model='temporal_ot' visual_encoder='resnet50' reward_model.cost_fn='cosine' logging.wandb_mode='online' 
