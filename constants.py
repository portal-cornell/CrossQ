...
REWARDS_TO_ENTRY_IN_SEQ = {
    ...
    "arms_bracket_left_basic_r_geom_xpos": "arms_bracket_left_final_only",

    "arms_bracket_right_goal_only_euclidean_geom_xpos": "arms_bracket_right_final_only",
    "arms_bracket_right_basic_r_geom_xpos": "arms_bracket_right_final_only",

    "arms_bracket_down_goal_only_euclidean_geom_xpos": "arms_bracket_down_final_only",
    "arms_bracket_down_basic_r_geom_xpos": "arms_bracket_down_final_only",

    "arms_bracket_up_goal_only_euclidean_geom_xpos": "arms_bracket_up_final_only",
    "arms_bracket_up_basic_r_geom_xpos": "arms_bracket_up_final_only",

    "arms_crossed_high_goal_only_euclidean_geom_xpos": "arms_crossed_high_final_only",
    "arms_crossed_high_basic_r_geom_xpos": "arms_crossed_high_final_only",
    ...
    "right_arm_out_basic_r_geom_xpos": "right_arm_out_final_only",

    "left_arm_extend_wave_higher_goal_only_euclidean_geom_xpos": "left_arm_extend_wave_higher_final_only",
    "left_arm_extend_wave_higher_basic_r_geom_xpos": "left_arm_extend_wave_higher_final_only",

    "left_arm_extend_wave_lower_goal_only_euclidean_geom_xpos": "left_arm_extend_wave_lower_final_only",
    "left_arm_extend_wave_lower_basic_r_geom_xpos": "left_arm_extend_wave_lower_final_only",

    "right_arm_extend_wave_higher_goal_only_euclidean_geom_xpos": "right_arm_extend_wave_higher_final_only",
    "right_arm_extend_wave_higher_basic_r_geom_xpos": "right_arm_extend_wave_higher_final_only",

    "right_arm_extend_wave_lower_goal_only_euclidean_geom_xpos": "right_arm_extend_wave_lower_final_only",
    "right_arm_extend_wave_lower_basic_r_geom_xpos": "right_arm_extend_wave_lower_final_only",
    ...
    "both_arms_out_basic_r_geom_xpos": "both_arms_out_final_only",
    ...
    "default_but_arms_up_basic_r_geom_xpos": "default_but_arms_up_final_only",
