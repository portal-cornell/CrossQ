...
# ############################### Prob cyclical ############################
# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_cycle" "env.temporal_encoding=True" "cost_fn=manhattan" "rl_algo.ent_coef=0.1" "env.episode_length=40" "seq_reward_model=prob_ranked" "seed=123"

# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_cycle" "env.temporal_encoding=True" "cost_fn=manhattan" "rl_algo.ent_coef=0.1" "env.episode_length=40" "seq_reward_model=prob_ranked" "seq_reward_model.rank_weighting=.25" "seed=123"

# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_nav_bigger" "env.temporal_encoding=True" "cost_fn=manhattan" "rl_algo.ent_coef=0.1" "env.episode_length=40" "seq_reward_model=prob_ranked" "seed=123",

# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_nav_bigger" "env.temporal_encoding=True" "cost_fn=manhattan" "rl_algo.ent_coef=0.1" "env.episode_length=40" "seq_reward_model=prob_ranked" "seq_reward_model.rank_weighting=.25" "seed=123"
...
# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_nav_bigger" "env.temporal_encoding=True" "cost_fn=manhattan" "rl_algo.ent_coef=0.1" "env.episode_length=40" "seq_reward_model=even_distribution" "seed=40"
...
# python rl_with_seq_matching.py "env=minigrid" "env.example_name=lava_nav_no_door" "env.temporal_encoding=False" "cost_fn=manhattan" "rl_algo.ent_coef=0" "env.episode_length=20" "seq_reward_model=optimal_transport" 
